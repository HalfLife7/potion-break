...
function main() {
    ...
    charityRepo.createTable()
        ...
        .then(() => {
            ...
            return Promise.all(charities.map((charity) => {
                let {
                    id,
                    name,
                    description,
                ...
                return dao.run(sql, [charity.id, charity.name, charity.description, charity.img_path]);
            }))
        })
        .then(() => {
            let games = [{
        ...
        new SteamStrategy({
            ...
            function (identifier, profile, done) {
                ...
                process.nextTick(function () {
                    ...
                    `;
                    let params = [userInfo.personaname, userInfo.profileurl, userInfo.steamid, userInfo.avatarfull];
