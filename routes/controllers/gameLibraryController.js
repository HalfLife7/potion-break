      ...
      `
        ...
        Axios.get(
            ...
            .then((response) => {
                ...
                getOwnedGamesData.games.forEach(function (
                    gameData,
                    index,
                    array
                ) {
                ...
                let filteredGamesData = getOwnedGamesData.games.filter(
                    function (game) {
                ...
                userInfo.total_games_played = Object.keys(
                    filteredGamesData
                ).length
                ...
                userInfo.total_time_played =
                    ...
                    (total_minutes_played -
                        Math.floor(total_minutes_played / 60) * 60) +
                    ' minutes'
        ...
        `
            ...
            `
                ...
                let dbUpsertUserGames = Promise.all(filteredGamesData).map(
                    (game) => {
